...
class RobotSerial : public serial::Serial {
 public:
  ...
  void ReadCompetition(RefereeRMULBuf &_competition_inf);
  void ReadCompetition(INFRMUCBuf &_competition_inf);
 ...
 private:
  ...
  // 比赛信息
  RefereeRMULBuf competition_ul_buf_;
  INFRMUCBuf competition_uc_buf_;
